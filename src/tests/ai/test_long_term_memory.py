...
async def test_recollect() -> None:
    long_term_memory: LongTermMemory = await LongTermMemory.remember_from_url("https://raw.githubusercontent.com/Voyz/ibeam/master/README.md", LongTermMemoryDocumentType.MARKDOWN)
